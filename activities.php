...
<html lang="en">
    ...
    <head>
        ...
        <meta name="keywords" content="Tour at Sri lanka activities,Activities in sri lanka,activities with tour at sri lanka,<?php foreach (Activities::all() as $Activi) { echo "," . $Activi['title']; } ?> ">">
