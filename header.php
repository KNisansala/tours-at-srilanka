...
<!--                  <ul class="sub-menu">
                ...
                <li class="menu_has_children"><a href="#">Gallery</a>
                  <ul class="sub-menu">
                ...
                <li class="menu_has_children"><a href="#">Attractions</a>

                </li>
                <li class="menu_has_children"><a href="#">Activities</a>

                </li>
                <li class="menu_has_children"><a href="#">Service</a>
                  <ul class="sub-menu">
                    <li><a href="contact-one.html">Contact One</a></li>
                    
                    <li><a href="contact-two.html">Contact Two</a></li>
                  </ul>
                    <li class="menu_has_children"><a href="#">Contact Us</a>
                  <ul class="sub-menu">
                    <li><a href="contact-one.html">Contact One</a></li>
